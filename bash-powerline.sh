...
__powerline() {
    ...
    readonly SYMBOL_WEATHER_SUNNY=' 🌣 '
    readonly SYMBOL_WEATHER_RAINY=' ⛆ '
    ...
    ps1() {
        ...
        case $weather in
            0)
                weather=$SYMBOL_WEATHER_SUNNY
                ;;
            1)
                weather=$SYMBOL_WEATHER_CLOUDY
                ;;
            2)
                weather=$SYMBOL_WEATHER_OVERCAST
                ;;
            3)
                weather=$SYMBOL_WEATHER_RAINY
                ;;
            4)
                weather=$SYMBOL_WEATHER_STORMY
                ;;
            5)
                weather=$SYMBOL_WEATHER_SNOWY
                ;;
            -1)
                weather=$SYMBOL_WEATHER_ERROR_NOINTERNET
                ;;
        esac

        PS1="$cwd$weather$git$symbol"
    }
